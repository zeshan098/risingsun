                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="green box1">
                      ...
                      <label for="country">Email</label>
                          <input type="email" class="form-control email" name="email" id="emails"  value=""  >
                      </div>
                      <div class="col-xs-6">
...
<script>
	$('#donation_form').on('submit',function(event){
		...
		$.ajax({
			url: 'donation_submit',
			type:'POST', 
			data: {  _token:_token,receipt:receipt, enter_date:enter_date, refer_by:refer_by, name:name, cust_name:cust_name, assign_to:assign_to, address:address,
