...
<section class="content">
	  ...
	  <div class="row">
		  ...
		  <main id="main">
             <form action="{{ url('admin/update_donation',$edit_donation->id) }}" id="donation_form" method="post" style=" ">
              ...
              <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                      <label for="country">Currency</label>
                       <input type="text" class="form-control currency" value="{{$edit_donation->currency}}" name="currency" >
                    </div>
                    <div class="col-xs-4">
                ...
                <div class="row" id="hidden_div" style="">
                    ...
                    <div class="col-xs-12 col-md-4">
                      ...
                      @else 
                        <input type="text" class="form-control datepicker draft_date" name="from_date" value="{{$edit_donation->from_date}}" disabled >
                    ...
                    <div class="col-xs-12 col-md-4">
                      ...
                      @if($edit_donation->to_date == '1970-01-01') 
                        <input type="text" class="form-control datepicker draft_date" name="to_date" value="" >
                      @else 
                        <input type="text" class="form-control datepicker draft_date" name="to_date" value="{{$edit_donation->to_date}}" disabled >
        ...
        <div id="contact-modal-2" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="contactFormDriver" method='POST' name="contact" action="{{url('admin/customer_add')}}" role="form">
