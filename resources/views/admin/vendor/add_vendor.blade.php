...
<section class="content">
    <div class="row">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="{{ url('admin/add_vendor') }}" id="employee_form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="first_name">Alt Phone #</label>
                        <input type="text" class="form-control" name="alt_phone_no" >
                        ...
                        <table id="users_list" class="table table-bordered table-striped">
                            ...
                            @foreach($vendor as $vendor)
                                <tr>
                                    ...
                                    <td>{{ date('d-m-Y', strtotime($vendor->date)) }}</td>  
                                    <td><a href="{{url('admin/update_vendor',$vendor->id)}}"><i class="fa fa-fw fa-edit"></i></a> |
                                     <a href="{{url('admin/delete_vendor',$vendor->id)}}"><i class="fa fa-trash fa-2" aria-hidden="true"></i></a></td>
